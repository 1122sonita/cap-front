              ...
              <div className='flex flex-wrap justify-center'>
                <Link href='/service'>
                  <a>
                    <button
                      type='button'
                      className='bg-secondary hover:bg-primary hover:text-white hover:scale-110 transition-all text-btn font-semibold text-center w-full rounded-full py-[5px] px-5 text-primary '
                    >
